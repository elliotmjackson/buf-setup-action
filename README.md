...
steps:
  ...
  # Install the `buf` CLI
  - uses: bufbuild/buf-setup-action@v1.1.4
...
|:---------------|:---------------------------------------------------|:-------------------|
| `version`      | The version of the [`buf` CLI][buf-cli] to install | [`v1.1.4`][version] |
...
[version]: https://github.com/bufbuild/buf/releases/tag/v1.1.4
